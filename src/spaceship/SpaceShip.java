...
//        }
        ...
        drawRocket(rocketImage,getX(rocketXPos),getY(rocketYPos),rocketRot,1,1);
        
        drawStar(starXPos,starYPos,0,1,1,Color.yellow);
...
////////////////////////////////////////////////////////////////////////////
    public void drawStar(int xpos,int ypos,double rot,double xscale,double yscale,Color color)
    {
        g.translate(xpos,ypos);
        g.rotate(rot  * Math.PI/180.0);
        g.scale( xscale , yscale );
